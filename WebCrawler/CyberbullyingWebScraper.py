"""
This is a web scraper that extracts tweets related to Cyberbullying and writes them to an output CSV file 
...
csvFile = open('Cyberbullying_dataset.csv', 'a')
csvWriter = csv.writer(csvFile)
header=['Cyberbullying Data']
...
for i in tweepy.Cursor(api.search,q="#cyberbullying", count=2000,lang="en", since="2018-04-01").items():
